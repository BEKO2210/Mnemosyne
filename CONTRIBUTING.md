...
Thanks for wanting to help. Mnemosyne is open source and we welcome contributions of all sizes — from typo fixes to new features.

## Getting Started

```bash
git clone https://github.com/beko2210/mnemosyne.git
cd mnemosyne
...
```
mnemosyne/          ← core package (see mnemosyne/README.md for module guide)
...
Check the [Issues](https://github.com/beko2210/mnemosyne/issues) tab. Great starting points:
