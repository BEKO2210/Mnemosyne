# mnemosyne/ — Core Package

The Python package that powers Mnemosyne. All modules, all logic.
...
| `config.py` | Configuration loading — `~/.mnemosyne/config.json`, env vars, defaults |
